report 54500 "Sales Invoice Excel Lolliland"
{
    DefaultLayout = RDLC;
    RDLCLayout = './SalesInvoiceExcel.rdl';
    Caption = 'Sales Invoice Lolliland';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(BilltoName_SalesInvHeader; "Sales Invoice Header"."Bill-to Name")
                    {
                    }
                    column(ShiptoName_SalesInvHeader; "Sales Invoice Header"."Ship-to Name")
                    {
                    }
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        Column(UnitCst; VarUnitCost)
                        {

                        }
                        column(Barcode; recItem."Barcode_NXN")
                        {

                        }
                        column(CTN_Qty; recItem."Bags per CTN NXN")
                        {
                        ...
                        begin
                            ...
                            if recItem.Get("No.") then begin
                                Clear(VarUnitCost);
                                recItem.CalcFields("Bags per CTN NXN");
                                if recItem."Bags per CTN NXN" > 0 then
                                    VarUnitCost := ("Line Amount" / Quantity) / recItem."Bags per CTN NXN"
                                else
                                    VarUnitCost := 1;
                            end;
    ...
    begin
        ...
        //with SalesShipmentBuffer do begin//NXN.SS
    ...
    begin
        // with SalesInvoiceHeader do begin  //NXN.SS
